...
const FEATURES: Feature[] = [
  {
    ...
    body: "Our matching engine pairs you based on goals, skills, interests, and experience — so every connection adds real value. Get personal recommendations from someone who already understands your journey.",
    image: "/mockup-3.jpg",
  ...
  },
  {
    ...
    body: "Whether you are a student finding direction, a professional navigating a career path, or a leader giving back — Thrybee makes it easy to connect, learn, and grow together across industries.",
    image: "/mockup-2.jpg",
